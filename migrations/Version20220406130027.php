...
final class Version20220406130027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company ( id SERIAL PRIMARY KEY, name VARCHAR(100) NOT NULL, image VARCHAR(255) NOT NULL, category_id INT NOT NULL, owner_id INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT (NOW()), updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deactivated_at TIMESTAMP(0) WITHOUT TIME ZONE )');
        ...
        $this->addSql('CREATE TABLE credit (id SERIAL PRIMARY KEY, user_id INT NOT NULL, reference VARCHAR(100) UNIQUE NOT NULL, amount_price INT NOT NULL, expiry date, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT (NOW()), updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deactivated_at TIMESTAMP(0) WITHOUT TIME ZONE )');
