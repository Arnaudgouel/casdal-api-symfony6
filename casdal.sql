...
-- Squences
CREATE SEQUENCE IF NOT EXISTS shopping_session_id_seq
...
('DoctrineMigrations\Version20220331112123', '2022-04-04 16:41:36', 444);
INSERT INTO "public"."doctrine_migration_versions" ("version", "executed_at", "execution_time") VALUES
('DoctrineMigrations\Version20220406130027', '2022-04-16 20:06:06', 324);

INSERT INTO "user" (email, roles, password, first_name, last_name)
values ('aaa@gmail.com', '["ROLE_USER"]', 'aaa', 'aa', 'a'),
('bbb@gmail.com', '["ROLE_USER"]', 'bbb', 'bb', 'b'),
('ccc@gmail.com', '["ROLE_USER"]', 'ccc', 'cc', 'c'),
('ddd@gmail.com', '["ROLE_USER"]', 'ddd', 'dd', 'd');

INSERT INTO company_category (title)
values ('Burger'),
('Pizza'),
('Sushi'),
('Tacos');

INSERT INTO company (name, image, company_category_id, owner_id)
values ('Kurger Bing', 'no', 1, 2),
